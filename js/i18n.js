...
const T = {
  fr: {
    ...
    'footer.copy':      '© 2025 XLDashboard. Tous droits réservés.',
    ...
    'feat.3.desc':   "Conçus par un praticien de l'audit interne et du contrôle de gestion. Chaque formule et structure respecte les bonnes pratiques sectorielles.",
    ...
    'prod.1.title':  'Enterprise Risk Management Toolkit',
    'prod.1.desc':   "Template ERM complet pour audit interne et gestion des risques d'entreprise. Edition anglaise.",
    ...
    'prod.2.title':  'Micro-Entrepreneur Dashboard 2026',
    'prod.2.desc':   'Tableau de bord complet pour auto-entrepreneurs : URSSAF 2026, trésorerie 12 mois et KPI activité en un seul fichier Excel.',
    ...
    'prod.3.title':  'Trucking Cost Price Simulator',
    'prod.3.desc':   'Calculateur de coût de revient au mile pour transporteurs routiers (carburant, fixe, variable, chauffeur). Edition US/anglaise.',
    ...
    'pp.r1.title': 'Enterprise Risk Management Toolkit',
    'pp.r1.desc':  "Template ERM complet pour identifier, évaluer et surveiller vos risques d'entreprise. Conforme aux standards d'audit interne. Edition anglaise.",
    'pp.r1.f1': 'Registre dynamique des risques (5×5)',
    'pp.r1.f2': 'Score automatique probabilité × impact',
    'pp.r1.f3': 'Plan de traitement des risques intégré',
    'pp.r1.f4': 'Dashboard KPI risques automatisé',
    'pp.r1.f5': 'Indicateurs d\'appétit & tolérance au risque',
    'pp.r2.title': 'RiskMap Pro — Cartographie des risques PME',
    'pp.r2.desc':  "Cartographie visuelle des risques PME : identifiez, classez et pilotez vos risques opérationnels simplement, sans jargon technique.",
    'pp.r2.f1': 'Carte thermique des risques couleur',
    'pp.r2.f2': 'Fiche risque par domaine (5 max)',
    'pp.r2.f3': 'Scoring simplifié probabilité × impact',
    'pp.r2.f4': 'Plan d\'action et responsable associé',
    ...
    'pp.f2.title': 'Micro-Entrepreneur Dashboard 2026',
    'pp.f2.desc':  "Tableau de bord complet pour auto-entrepreneurs et micro-entreprises : simulation URSSAF, trésorerie 12 mois et suivi des KPI activité.",
    'pp.f2.f1': 'Simulation URSSAF par régime 2026',
    'pp.f2.f2': 'Trésorerie prévisionnelle 12 mois',
    'pp.f2.f3': 'Suivi CA mensuel vs objectif',
    'pp.f2.f4': 'Alertes seuil franchise TVA',
    ...
    'pp.l1.title': 'Trucking Cost Price Simulator',
    'pp.l1.desc':  "Calculateur de coût de revient au mile pour transporteurs routiers US. Carburant, amortissement, entretien, chauffeur — tout est inclus. Edition anglaise.",
    'pp.l1.f1': 'Coût par mile / km détaillé',
    'pp.l1.f2': 'Décomposition carburant, fixes, variables',
    'pp.l1.f3': 'Comparaison devis vs coût réel',
    'pp.l1.f4': 'Seuil de rentabilité par trajet',
    'pp.l1.f5': 'Rapport mensuel automatisé',
    ...
    'about.profile.title': 'Expert Audit Interne & Contrôle de Gestion · Fondateur XLDashboard',
    'about.profile.stat1': "Ans d'expérience",
    'about.profile.stat2': 'Templates disponibles',
    ...
    'about.profile.name': 'Le Fondateur',
    'about.bio.h1':      'Qui suis-je ?',
    'about.bio.p1':      "Professionnel de l'audit interne et du contrôle de gestion avec 19 ans d'expérience dans des environnements exigeants — industrie, services et transport.",
    'about.bio.p2':      "Certifié IFACI en audit interne, j'ai développé au fil des années de solides compétences en informatique, création de dashboards et conception de templates Excel professionnels. Ces outils ont accompagné toute ma carrière.",
    'about.bio.p3':      "J'ai fondé <strong>XLDashboard</strong> pour mettre cette expertise à disposition des professionnels qui cherchent des outils rigoureux, directement opérationnels et conçus par un praticien du terrain.",
    ...
    'about.exp.5.name':  'Excel & Dashboards',
    'about.exp.5.desc':  'Templates professionnels, automatisation, visualisation',
    'about.exp.6.name':  'Informatique',
    'about.exp.6.desc':  "Outils bureautiques avancés, systèmes d'information",
    'about.timeline.h':  'Mon parcours',
    'about.tl.1.title':  'Auditeur Interne & Contrôleur de Gestion',
    'about.tl.1.co':     'Secteurs industrie, services et transport — 19 ans d\'expérience',
    'about.tl.2.title':  'Fondateur XLDashboard',
    'about.tl.2.co':     'Création et vente de templates Excel professionnels',
    'about.cert.name':   'Certifié IFACI',
    'about.cert.desc':   "Institut Français de l'Audit et du Contrôle Internes",
  ...
  en: {
    ...
    'footer.copy':      '© 2025 XLDashboard. All rights reserved.',
    ...
    'feat.3.desc':   'Designed by a practitioner of internal audit and management control. Each formula and structure follows industry best practices.',
    ...
    'about.profile.name': 'The Founder',
    'about.profile.title': 'Internal Audit & Management Control Expert · Founder of XLDashboard',
    'about.profile.stat1': 'Years of Experience',
    'about.profile.stat2': 'Templates Available',
    'about.profile.stat3': 'Key Domains',
    'about.profile.stat4': 'Satisfaction',
    'about.profile.l1':  'Send a Message',
    'about.profile.l2':  'LinkedIn',
    'about.profile.l3':  'View My Templates',
    'about.bio.h1':      'Who Are We?',
    'about.bio.p1':      'Internal audit and management control professional with 19 years of experience in demanding environments — industry, services and transport.',
    'about.bio.p2':      'IFACI-certified in internal audit, I have developed over the years strong skills in IT, dashboard creation and professional Excel template design. These tools have accompanied my entire career.',
    'about.bio.p3':      'I founded <strong>XLDashboard</strong> to make this expertise available to professionals looking for rigorous, immediately operational tools designed by a field practitioner.',
    ...
    'about.exp.5.name':  'Excel & Dashboards',
    'about.exp.5.desc':  'Professional templates, automation, visualization',
    'about.exp.6.name':  'IT & Tools',
    'about.exp.6.desc':  'Advanced office tools, information systems',
    'about.timeline.h':  'My Career Path',
    'about.tl.1.title':  'Internal Auditor & Management Controller',
    'about.tl.1.co':     'Industry, services and transport sectors — 19 years of experience',
    'about.tl.2.title':  'Founder XLDashboard',
    'about.tl.2.co':     'Creation and sale of professional Excel templates',
    'about.cert.name':   'IFACI Certified',
    'about.cert.desc':   'French Institute of Internal Audit and Control',
  ...
  ar: {
    ...
    'footer.copy':      '© 2025 XLDashboard. جميع الحقوق محفوظة.',
    ...
    'feat.3.desc':   'صُمّمت من قِبَل متخصص في التدقيق الداخلي ومراقبة التسيير. كل معادلة وهيكل يحترم أفضل الممارسات القطاعية.',
    ...
    'about.profile.name': 'المؤسس',
    'about.profile.title': 'خبير التدقيق الداخلي ومراقبة التسيير · مؤسس XLDashboard',
    'about.profile.stat1': 'سنوات خبرة',
    'about.profile.stat2': 'قوالب متاحة',
    ...
    'about.bio.h1':      'من أنا؟',
    'about.bio.p1':      'متخصص في التدقيق الداخلي ومراقبة التسيير مع 19 سنة من الخبرة في بيئات متطلبة — الصناعة والخدمات والنقل.',
    'about.bio.p2':      'حاصل على شهادة IFACI في التدقيق الداخلي، طوّرت على مر السنين كفاءات راسخة في الإعلام الآلي، إنشاء لوحات القيادة وتصميم قوالب Excel الاحترافية. رافقت هذه الأدوات مسيرتي المهنية بأكملها.',
    'about.bio.p3':      'أسّستُ <strong>XLDashboard</strong> لإتاحة هذه الخبرة للمهنيين الباحثين عن أدوات صارمة وجاهزة للعمل مباشرة، صُمّمت من قِبَل ممارس ميداني.',
    ...
    'about.exp.5.name':  'Excel ولوحات القيادة',
    'about.exp.5.desc':  'قوالب احترافية، أتمتة، تصور البيانات',
    'about.exp.6.name':  'الإعلام الآلي',
    'about.exp.6.desc':  'أدوات مكتبية متقدمة، أنظمة المعلومات',
    'about.timeline.h':  'مساري المهني',
    'about.tl.1.title':  'مدقق داخلي ومراقب تسيير',
    'about.tl.1.co':     'قطاعات الصناعة والخدمات والنقل — 19 سنة من الخبرة',
    'about.tl.2.title':  'مؤسس XLDashboard',
    'about.tl.2.co':     'إنشاء وبيع قوالب Excel الاحترافية',
    'about.cert.name':   'شهادة IFACI',
    'about.cert.desc':   'المعهد الفرنسي للتدقيق والرقابة الداخلية',
